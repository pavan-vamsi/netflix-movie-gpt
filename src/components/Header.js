...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-gray-800 z-20 flex flex-col md:flex-row justify-between">
      ...
      {user && (
        <div className="flex p-2 justify-between">
          ...
          <button
            ...
            className="py-2 px-4 mx-4 my-2 bg-purple-700 text-white rounded-xl"
          >
